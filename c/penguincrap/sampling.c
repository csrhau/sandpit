...
struct {
   ...
   void  (*open)( int dev );  // Open function
        ...
        { -1, "/sys/devices/ocp.3/helper.10/AIN0", ainTransfer, openAIN },
        { -1, "/sys/devices/ocp.3/helper.10/AIN1", ainTransfer, openAIN },
        { -1, "/sys/devices/ocp.3/helper.10/AIN2", ainTransfer, openAIN },
        { -1, "/sys/devices/ocp.3/helper.10/AIN3", ainTransfer, openAIN },
        { -1, "/sys/devices/ocp.3/helper.10/AIN4", ainTransfer, openAIN },
        { -1, "/sys/devices/ocp.3/helper.10/AIN5", ainTransfer, openAIN },
